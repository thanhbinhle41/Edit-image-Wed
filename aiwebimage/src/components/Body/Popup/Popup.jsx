...
export default function Popup({showPopup, setShowPopup, api, setApi, listImg, setListImg}) {
    ...
    const [predictTmp, setPredictTmp] = useState('');
    ...
    const handlePostAPI = () => {
        ...
        // setShowPredictImg(false);
        // setTimeout(() => {
        //     axios.get('http://127.0.0.1:8080/api/view/')
        //     .then(item => {
        //         setListImg(item.data);
        //         console.log('get API thanh cong');   
        //         console.log(listImg);
        //         let tmpURL = "http://127.0.0.1:8080" + listImg.predict;
        //         setPredictImg(tmpURL);
        //         setShowPredictImg(true);
    ...
    const handleAPI = () => {
        axios.get('http://127.0.0.1:8080/api/view/')
            .then(item => {
                setListImg(item.data);
                let alo123 = "http://127.0.0.1:8080" + listImg.predict;
                console.log('MXL', alo123);
                setPredictTmp(alo123);
                console.log(predictTmp);
